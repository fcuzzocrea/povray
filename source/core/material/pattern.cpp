        ...
        if((Ex >= 0.0) && (Ex < 1.0) && (Ey >= 0.0) && (Ey < 1.0) && (Ez >= 0.0) && (Ez < 1.0))
        {
            switch (densityFile->Interpolation)
            {
                ...
                case kDensityFileInterpolation_BlobEight:
                    ...
                    rx[3]=max((int)0,(int)x1);        ry[3]=max((int)0,(int)y1);        rz[3]=max((int)0,(int)z1);
                    rx[2]=max((int)0,(int)x1-(int)1); ry[2]=max((int)0,(int)y1-(int)1); rz[2]=max((int)0,(int)z1-(int)1);
                    rx[1]=max((int)0,(int)x1-(int)2); ry[1]=max((int)0,(int)y1-(int)2); rz[1]=max((int)0,(int)z1-(int)2);
                    rx[0]=max((int)0,(int)x1-(int)3); ry[0]=max((int)0,(int)y1-(int)3); rz[0]=max((int)0,(int)z1-(int)3);
                    //---
